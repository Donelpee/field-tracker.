            ...
            <div className="flex relative">
                ...
                {sidebarOpen && (
                    <button
                        ...
                        className="fixed top-4 left-64 w-10 h-10 !bg-white border border-gray-200 rounded-full items-center justify-center shadow-lg hover:bg-gray-50 !text-gray-500 z-[9999] transform transition-transform hover:scale-110 ml-4 hidden lg:flex"
