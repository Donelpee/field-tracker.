            ...
            <div className="grid gap-3">
                {loading ? (
                    ...
                    paginatedTypes.map((type) => (
                        <div
                            key={type.id}
                            className="group bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3"
                        >
                            <div className="flex items-center gap-4 min-w-0 w-full sm:w-auto">
                                ...
                                <div className="min-w-0">
                                    <h4 className="font-bold text-gray-800 dark:text-white text-lg truncate">{type.title}</h4>
                                    {type.description && (
